            ...
            args: [
                { repo: undefined },
                {
                    ...
                    facets: [
                        ...
                        { features: [{ "$type": "blue.poll.post.facet#question", },], index: { byteEnd: 10, byteStart: 0, }, },
                        { features: [{ "$type": "blue.poll.post.facet#option", number: 1, },], index: { byteEnd: 64, byteStart: 56, }, },
                        { features: [{ "$type": "blue.poll.post.facet#option", number: 2, },], index: { byteEnd: 78, byteStart: 70, }, },
                        { features: [{ "$type": "blue.poll.post.facet#option", number: 3, },], index: { byteEnd: 92, byteStart: 84, }, },
                        { features: [{ "$type": "blue.poll.post.facet#option", number: 4, },], index: { byteEnd: 110, byteStart: 98, }, },
                    ],
                    createdAt,
                }
            ]
